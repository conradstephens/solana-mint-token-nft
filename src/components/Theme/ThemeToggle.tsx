...
export default function ThemeToggle() {
  ...
  return (
    <div className="dropdown-end dropdown">
      <label
        tabIndex={0}
        className="swap-rotate btn btn-square btn-ghost swap relative m-1"
      >
        <input
          className="invisible"
          type="checkbox"
      ...
      <ul
        tabIndex={0}
        className="menu dropdown-content rounded-box w-52 bg-base-100 p-2 shadow-2xl dark:bg-neutral"
      >
        <li>
          <a
